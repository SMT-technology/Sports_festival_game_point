...
import type { AppSettings, ClassRow, EventRow, ScoreRow } from "@/lib/database.types";
...
export default async function ResultsPage() {
  ...
  const [{ data: classesData }, { data: eventsData }, { data: scoresData }, { data: settingsData }] =
    await Promise.all([
  ...
  return (
    <ResultsClient
      ...
      initialRankingsVisible={(settingsData as AppSettings | null)?.rankings_visible ?? true}
    />
  );
}
