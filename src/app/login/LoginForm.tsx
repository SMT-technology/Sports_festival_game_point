...
export function LoginForm({ orgName, logoUrl }: { orgName: string; logoUrl: string }) {
  return (
    <Suspense fallback={null}>
      <LoginFormInner orgName={orgName} logoUrl={logoUrl} />
    </Suspense>
  );
}

function LoginFormInner({ orgName, logoUrl }: { orgName: string; logoUrl: string }) {
